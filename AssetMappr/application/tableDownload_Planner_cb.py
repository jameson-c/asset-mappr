...
#         prevent_initial_call=True,
#     )
#     def download_function(csv_clicks, pdf_clicks, df_cnm, asset_categories, missing_assets, rating_score, rating_values, type_of_assets):
...
#         if csv_clicks:
#             if type_of_assets == 'Existing Assets':
#                 return dcc.send_data_frame(df.to_excel, "existing_assets.xlsx", sheet_name='Existing Assets'), None
#             if type_of_assets == 'Missing Assets':
#                 return dcc.send_data_frame(missing_df.to_excel, "missing_asset_suggestions.xlsx", sheet_name='Missing Suggested Assets'), None
#             raise PreventUpdate

#         if pdf_clicks:
#             if type_of_assets == 'Existing Assets':
#                 return None, dcc.send_bytes(lambda x: write_image(existing_figure, x, format=fmt), "existing asset.{}".format(fmt))
#             if type_of_assets == 'Missing Assets':
#                 return None, dcc.send_bytes(lambda x: write_image(missing_figure, x, format=fmt), "missing asset.{}".format(fmt))
#             raise PreventUpdate
