...
def tableDownload_Planner_cb(app, df, asset_categories, missing_assets, rating_score, rating_values):
    ...
    def update_table(type_of_assets):
        ...
        nonlocal df, missing_df # so this nested function can access the dataframes created outside it
    ...
    @app.callback(
        ...
        [Input('download_button', 'n_clicks')], # Download only triggers when button is clicked, hence INput-State pair
